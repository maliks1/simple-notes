    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100 font-sans antialiased selection:bg-zinc-800">
      ...
      <nav className="max-w-4xl mx-auto px-6 py-6 flex justify-between items-center">
        <span className="text-lg font-semibold tracking-tight">
          simple notes <span className="text-zinc-500">.</span>
        </span>
        <CreateNoteButton className="text-sm bg-zinc-100 text-zinc-950 px-4 py-2 rounded-md hover:bg-white transition-colors">
          Buat Catatan
        </CreateNoteButton>
      </nav>
      ...
      <section className="max-w-4xl mx-auto px-6 pt-24 pb-32 text-center">
        ...
        <div className="mt-10 flex justify-center gap-4">
          <CreateNoteButton className="bg-white text-zinc-950 px-6 py-3 rounded-md font-medium hover:bg-zinc-200 transition-colors">
            Mulai Menulis →
          </CreateNoteButton>
        </div>
      </section>
